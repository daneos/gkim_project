	...
	\section{Opis formatu}
		...
		\subsection{Dane kodowania}
			...
			\subsubsection{Huffman}
				Nagłówek algorytmu Huffmana składa się z: 2-bajtowego rozmiaru słownika, 2-bajtowej dlugości najdłuższego kodu Huffmana, słownika do dekodowania oraz zapisana 4-bajtowo ilość potrzebna na ustawienie rozmiaru bufora do dekodowania.
			\subsubsection{LZ77}
